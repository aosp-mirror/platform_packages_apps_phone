            ...
            if (buttonNetworkMode != settingsNetworkMode) {
                ...
                switch(buttonNetworkMode) { //Extend to enable user choise of other network modes
                    case RILConstants.NETWORK_MODE_GSM_UMTS:
                        modemNetworkMode = RILConstants.NETWORK_MODE_GSM_UMTS;
                        break;
                    case RILConstants.NETWORK_MODE_CDMA:
                        modemNetworkMode = RILConstants.NETWORK_MODE_CDMA;
                        break;
                    case RILConstants.NETWORK_MODE_GLOBAL:
                        modemNetworkMode = RILConstants.NETWORK_MODE_GLOBAL;
                        break;
                    default:
                        modemNetworkMode = RILConstants.PREFERRED_NETWORK_MODE;
                } 
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                ...
                if (modemNetworkMode == RILConstants.NETWORK_MODE_WCDMA_PREF ||  
                        modemNetworkMode == RILConstants.NETWORK_MODE_GSM_ONLY ||
                        modemNetworkMode == RILConstants.NETWORK_MODE_WCDMA_ONLY ||
                        modemNetworkMode == RILConstants.NETWORK_MODE_GSM_UMTS ||
                        modemNetworkMode == RILConstants.NETWORK_MODE_CDMA ||
                        modemNetworkMode == RILConstants.NETWORK_MODE_CDMA_NO_EVDO ||
                        modemNetworkMode == RILConstants.NETWORK_MODE_EVDO_NO_CDMA ||
                        modemNetworkMode == RILConstants.NETWORK_MODE_GLOBAL ) {
                    if (DBG) {
