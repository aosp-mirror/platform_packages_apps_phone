...
public class Settings extends PreferenceActivity implements DialogInterface.OnClickListener,
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mButtonPreferredNetworkMode) {
            ...
            int settingsNetworkMode = android.provider.Settings.System.getInt(mPhone.getContext().getContentResolver(),
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // set the listener for the mButtonPreferredNetworkMode list preference so we can issue change Preferred Network Mode.
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                ...
                if (DBG) log("handleGetPreferredNetworkTypeResponse: modemNetworkMode = " + modemNetworkMode);
                
                int settingsNetworkMode = android.provider.Settings.System.getInt(mPhone.getContext().getContentResolver(),
                        android.provider.Settings.System.PREFERRED_NETWORK_MODE, preferredNetworkMode);
                
                if (DBG) log("handleGetPreferredNetworkTypeReponse: settingsNetworkMode = " + settingsNetworkMode);
                
                //check that modemNetworkMode is from an accepted value
                if (modemNetworkMode == Phone.NT_GLOBAL_AUTO_TYPE ||  
                        modemNetworkMode == Phone.NT_CDMA_EVDO_AUTO_TYPE ||
                        modemNetworkMode == Phone.NT_GSM_UMTS_AUTO_TYPE ) {
                    if (DBG) log("handleGetPreferredNetworkTypeResponse: if 1: modemNetworkMode = " + modemNetworkMode);
                
                    //check changes in modemNetworkMode and updates settingsNetworkMode 
                    if (modemNetworkMode != settingsNetworkMode) {
                        if (DBG) log("handleGetPreferredNetworkTypeResponse: if 2: modemNetworkMode != settingsNetworkMode");
                        
                        settingsNetworkMode = modemNetworkMode;
                        
                        if (DBG) log("handleGetPreferredNetworkTypeResponse: if 2: settingsNetworkMode = " + settingsNetworkMode);
                        ...
                        mButtonPreferredNetworkMode.setValue(
                                Integer.toString(modemNetworkMode)); //TODO Remove, rewrite a better algorithm to keep track of this!!
                    }
                else {
        ...
        private void handleSetPreferredNetworkTypeResponse(Message msg) {
            ...
            if (ar.exception == null) {
                int networkMode = Integer.valueOf(mButtonPreferredNetworkMode.getValue()).intValue();
                android.provider.Settings.System.putInt(mPhone.getContext().getContentResolver(),
                        android.provider.Settings.System.PREFERRED_NETWORK_MODE, 
                        networkMode );
            } else {
