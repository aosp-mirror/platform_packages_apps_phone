...
public class CellBroadcastSms extends PreferenceActivity
    ...
    private static final int MAX_LENGTH_RESULT =
        NO_OF_SERVICE_CATEGORIES * NO_OF_INTS_STRUCT_1 + 1;
    //Handler keys
        ...
        if (preference == mButtonBcSms) {
            ...
            if(mButtonBcSms.isChecked()) {
                ...
                android.provider.Settings.System.putInt(mPhone.getContext().getContentResolver(),
                        android.provider.Settings.System.CDMA_CELL_BROADCAST_SMS,
    ...
    protected void onResume() {
        ...
        int settingCbSms = android.provider.Settings.System.getInt(mPhone.getContext().getContentResolver(),
                android.provider.Settings.System.CDMA_CELL_BROADCAST_SMS,
                RILConstants.CDMA_CELL_BROADCAST_SMS_DISABLED);            
    ...
    private static final class CellBroadcastSmsConfig {
        ...
        //NO_OF_SERVICE_CATEGORIES +1is used, because we will leave the first array entry 0
