...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private void handleVoicePrivacyClickRequest(boolean value) {
        mPhone.enableEnhancedVoicePrivacy(value, Message.obtain(mSetOptionComplete, 
    ...
    private Handler mSetOptionComplete = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_ENHANCED_VP_EXECUTED:
                if (DBG) {
                    Log .d(LOG_TAG, "setOptionComplete: Received event EVENT_ENHANCED_VP_EXECUTED");
                }
                handleSetVPMessage();
                break;
                default:
    ...
    private void handleSetVPMessage() {
        mPhone.getEnhancedVoicePrivacy(Message.obtain(mGetOptionComplete, 
                EVENT_ENHANCED_VP_EXECUTED));
    }
    ...
    private Handler mGetOptionComplete = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_ENHANCED_VP_EXECUTED:
                if (DBG) {
                    Log.d(LOG_TAG, "getOptionComplete: Received event EVENT_ENHANCED_VP_EXECUTED");
                }
