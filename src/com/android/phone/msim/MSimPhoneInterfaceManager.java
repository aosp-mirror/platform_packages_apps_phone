...
public class MSimPhoneInterfaceManager extends ITelephonyMSim.Stub {
    ...
    public boolean supplyPin(String pin, int subscription) {
        return (supplyPinReportResult(pin, subscription) == PhoneConstants.PIN_RESULT_SUCCESS)
            ? true : false;
    }
    ...
    public boolean supplyPuk(String puk, String pin, int subscription) {
        return (supplyPukReportResult(puk, pin, subscription) == PhoneConstants.PIN_RESULT_SUCCESS)
            ? true : false;
    }
