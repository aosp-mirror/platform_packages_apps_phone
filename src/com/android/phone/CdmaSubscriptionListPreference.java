...
public class CdmaSubscriptionListPreference extends ListPreference {
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        // Do not store new value in persistent storage because modem can
        // return error. We can update the persistent storage (android DB)
        // only after getting a positive response from the modem.
