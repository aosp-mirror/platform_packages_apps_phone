 ...
 *
 * TODO: We have moved in call notification from here to UI but we keep
 *       some other call realted notifications here for now. Like Call
 *       forward, missed call and voicemail. Not sure if thes really should
 *       be moved to UI...
 */
        ...
        if (visible) {
            ...
            if ((vmNumber == null) && !mPhone.getIccRecordsLoaded()) {
                ...
                if (mVmNumberRetriesRemaining-- > 0) {
                    ...
                    // TODO: We removed the whole CallNotifier so we need to handle this elsewhere.
                    return;
                } else {
